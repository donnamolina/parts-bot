...
DR_TO_ENGLISH = {
    ...
    "bumper": "bumper cover",
    "bumper delantero": "front bumper cover",
    "bumper trasero": "rear bumper cover",
    "guia de bumper": "bumper bracket",
    "guía de bumper": "bumper bracket",
    "guia bumper": "bumper bracket",
    "guía bumper": "bumper bracket",
    ...
    "pantalla delantera": "front bumper fascia",  # in RD cotizaciones = front fascia/bumper cover
    "pantalla": "headlight",
    "stop": "tail light",
    "violeta": "tail light",
    "cocuyo": "side marker",
    ...
    "frentil":                      "front clip",
    "base de pantallas":            "headlight bracket",
    "base de pantalla":             "headlight bracket",    # singular
...
def translate_part(name_original: str) -> dict:
    ...
    english = DR_TO_ENGLISH.get(cleaned.lower())

    if not english:
        # Try partial matches — longest key first
...
PART_TO_CATEGORY = {
    ...
    "guia de bumper": ("body & lamp assembly", ["bumper cover support", "bumper cover retainer"]),
